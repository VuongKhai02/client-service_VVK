...
@Component({
  selector: 'tb-entities-table-widget-search-date',
  templateUrl: './entities-table-widget-search-date.component.html',
  styleUrls: ['./entities-table-widget-search-date.component.scss', './table-widget.scss']
})
export class EntitiesTableWidgetSearchDateComponent extends PageComponent implements OnInit, AfterViewInit {
  ...
  public onDataUpdated(start, end) {
    this.updateTitle(true);
    this.entityDatasource.dataUpdated(start, end);
    this.clearCache();
